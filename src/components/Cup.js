      ...
      <div ref={myRef} className="glass">
        ...
        <svg viewBox="0 0 550 980">
          <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="399.6879" y1="462.5569" x2="516.6628" y2="462.5569">
            <stop  offset="0.1021" style={{stopColor:"#FFFFFF", stopOpacity:"0"}}/>
            <stop  offset="1" style={{stopColor:"#FFFFFF"}}/>
          </linearGradient>
          <path className="st0" fill="url(#SVGID_1_)" d="M399.69,81.11c39.58-2.26,83.23-10.35,104.66-14.72c6.71-1.37,12.84,4.07,12.28,10.89
            c-11.21,135.24-66.63,741.35-68.14,757c-1.57,16.27-35.15,24.66-35.15,24.66C439.56,549.38,399.69,81.11,399.69,81.11z"/>
          <path className="st1" fill="#FFFFFF" d="M507.67,73.32"/>
          <path className="st2" fill="#FFFFFF" style={{opacity:"0.85"}} d="M519.05,43.86c-19.85,4.57-40.18,6.98-60.48,8.99c-20.32,1.97-40.7,3.3-61.1,4.29
          ...
          <path className="st3" style={{opacity:"0.86"}} fill="#FFFFFF" d="M333.03,908.96c-19.07-1.51-41.93-2.67-58.03-2.67s-38.96,1.16-58.03,2.67c-19.06,1.52-38.08,3.67-56.93,6.86
          ...
          <path className="st4" style={{opacity:"0.5"}} fill="#FFFFFF" d="M275,829.75c-32.91,0-89.08,3.57-132.66,10.66l0.21,1.39c43.66-5.88,95.72-7.05,132.45-7.05
          ...
          <path className="st5" fill="url(#SVGID_2_)" d="M150.31,81.11c-39.58-2.26-83.23-10.35-104.66-14.72c-6.71-1.37-12.84,4.07-12.28,10.89
          ...
          <path className="st1" d="M549.97,30.97c-0.02-0.6-0.13-1.13-0.27-1.67c-0.14-0.52-0.29-1.11-0.48-1.54c-0.38-0.87-0.85-1.8-1.32-2.4
